        ...
        public void OnActionEvent(ActionEvent message)
        {
            switch (message.ActionId)
            {
                case "MSFSPanelGrabberPlugin.Plugin.Action.Init":
                    ...
                    var initSplitX = message["MSFSPanelGrabberPlugin.Plugin.Action.Init.Data.SplitX"] ?? "<null>";
                    var initSplitY = message["MSFSPanelGrabberPlugin.Plugin.Action.Init.Data.SplitY"] ?? "<null>";

                    _logger?.LogInformation($"[OnAction] Init Grabber with PosX: '{initPosX}', Posy: '{initPosY}', SplitX: '{initSplitX}', SplitY: '{initSplitY}'");
                    _screenGrabber?.InitGrabber(initPosX, initPosY, initSplitX, initSplitY);
